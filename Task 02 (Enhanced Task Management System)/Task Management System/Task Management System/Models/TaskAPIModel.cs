...
namespace Task_Management_System.Models
{
    public class TaskAPIModel
    {
        ...
        public int TaskCreatedUserID { get; set; }   //OwnerId / User who created task
        public string TaskCreatedUserName { get; set; }
        ...
        public async Task<int> AddTask()
        {
            ...
            t.IsActive = true ;
            t.TaskCreatedUserID = (int?)HttpContext.Current.Session["UserId"];
            t.TaskCreatedUserName = (string)HttpContext.Current.Session["UserName"];
        ...
        public async Task<int> UpdateTask()
        {
            ...
            else
            {
                ...
                exist.TaskCreatedUserID = (int?)HttpContext.Current.Session["UserId"];
                exist.TaskCreatedUserName = (string)HttpContext.Current.Session["UserName"];
