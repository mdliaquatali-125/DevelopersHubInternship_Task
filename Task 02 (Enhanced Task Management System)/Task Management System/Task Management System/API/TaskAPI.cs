        ...
        public async Task<IHttpActionResult> UpdateTask(TaskAPIModel model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (result == 1)
                    {
                        SharedTaskAPIModel models= new SharedTaskAPIModel();
                       
                        int Notification = await models.SendNotifications(model.TaskID);
                        ...
                        else
                        {
                            ...
                            {
                                Status = "Error",
                                Message = "Task updated but notification failed.",
                                URL = "/Task/Index"
                            });
                        }
                    }
